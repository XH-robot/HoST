...
class ThsCfg( LeggedRobotCfg ):
    ...
    class asset( LeggedRobotCfg.asset ):
        ...
        ankle_joints = [ 'left_ankle_pitch_joint', 'right_ankle_pitch_joint','left_ankle_roll_joint', 'right_ankle_roll_joint']

        trunk_names = ["base", "torso"]
        base_name = 'torso_link' #辅助力施加这个link上
        ...
        left_joints_names = left_leg_joints + left_arm_joints
        right_joints_names = right_leg_joints + right_arm_joints
...
class ThsCfgPPO( LeggedRobotCfgPPO ):
